...
TOPIC = "minRot_harmonic_realDevice_multiExp_mitig"
...
for expIt in range(0, nExp):
    ...
    while mrot <= PI/2:
        qft = transform(qft_framework, minRotation=mrot, suppressPrint=False, simulation=False, backend=device, noiseMitigationOpt=1)
