...
y_hat, f, t = test_stft(y, nSamplesWindow=windowLength, overlapFactor=overlapFactor, windowType=windowType)
stft.show(y_hat, f, t=t, subplot=[1,3,3], scale='mel', fmax=4000, autopower=False)
