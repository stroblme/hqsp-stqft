...
stqft = transform(stqft_framework, minRotation=mrot, suppressPrint=True, simulation=True, backendName="ibmq_manhattan")
y_hat_stqft, f, t = stqft.forward(y, nSamplesWindow=windowLength, overlapFactor=overlapFactor, windowType=windowType)
...
exp.setData(export.SIGNAL, y_hat_stqft)
exp.setData(export.DESCRIPTION, f"stqft, ibmq_casablanca, chirp, window: 'hann', length=2**7, mrot:{mrot}")
exp.setData(export.PLOTDATA, plotData)
